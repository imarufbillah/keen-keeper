    ...
    <Link href={`/${id}`}>
      <div className="p-5 sm:p-6 bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-200 flex flex-col gap-4 items-center">
        ...
        <div className="flex flex-col gap-2 justify-center items-center w-full">
          ...
          <div className="">
            <span
              className={`px-2.5 py-1 rounded-full text-xs font-medium capitalize ${status === "overdue" ? "bg-[#FEE2E2] text-red-600" : status === "almost due" ? "bg-[#FEF3C7] text-amber-700" : "bg-primary text-white"} bg-[#CBFADB] text-primary`}
            >
              {status}
            </span>
          </div>
